...
<h1 class ="mb-3 text-center">{{ $title }}</h1>
    ...
    @if($posts -> count())
        <div class="card mb-3">
            ...
            <p class="card-text">{{ $posts[0]->excerpt }}</small></p>
            ...
            <div class="col-md-4 mb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text">By: <a href="/posts?author={{ $post->author->username}}" class ="text-decoration-none">{{ $post->author->name }} {{ $post->created_at -> diffForHumans() }}</p>
